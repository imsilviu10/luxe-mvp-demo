...
export default function AdvertiserAdPage() {
  ...
  const canPay = adminStatus === "payment" || adminStatus === "approved";
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 pb-14 pt-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl font-bold tracking-tight md:text-6xl">
              Statusul anunțului tău.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
              Aici advertiserul vede statusul verificării, moderării, plății și
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 md:p-8">
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-bold">Preview anunț</h2>
            </div>
          ...
          {hasAd ? (
            <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-black/30">
              ...
              <div className="p-6">
                <div className="mb-3 inline-flex rounded-full bg-white/10 px-3 py-1 text-xs text-white/70">
                  {hasVerification ? "Verificare 18+ trimisă" : "Draft"}
                </div>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
                    <p className="text-sm text-white/50">Fotografii</p>
                    <p className="mt-2 font-semibold">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-black/30 p-10 text-center">
              <h3 className="text-2xl font-bold">
                Nu există încă un anunț demo.
              </h3>

              <p className="mx-auto mt-3 max-w-xl leading-7 text-white/60">
                Creează un anunț, treci prin verificare și apoi revino aici ca
                să vezi statusul.
              </p>
        ...
        <aside className="space-y-6">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6">
            ...
            <h2 className="mt-3 text-2xl font-bold">Procesul anunțului</h2>
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                ...
                >
                  1. Formular completat
                </p>

                <p className="mt-1 text-sm text-white/50">
                  Anunțul a fost creat ca draft.
                </p>
              </div>
              ...
              >
                ...
                <p className="mt-1 text-sm text-white/50">
                  {hasVerification
                    ? "Documentele demo au fost trimise."
              ...
              >
                ...
                <p className="mt-1 text-sm text-white/50">
                  {paymentStatus === "paid"
                    ...
                    : canPay
                      ? "Anunțul este aprobat pentru plată."
                      : "Plata devine disponibilă după aprobare."}
                </p>
              </div>
              ...
              >
                ...
                <p className="mt-1 text-sm text-white/50">
                  {isPublished
                    ...
                    : "Anunțul va deveni activ după plată."}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-[2rem] border border-amber-500/20 bg-amber-500/10 p-6">
            <h2 className="text-xl font-bold text-amber-200">Demo local</h2>

            <p className="mt-3 text-sm leading-7 text-amber-100/70">
              În acest moment statusurile sunt citite din localStorage. Mai
              târziu le vom salva în baza de date și le vom lega de contul real
              al advertiserului.
            </p>
          </div>
        </aside>
